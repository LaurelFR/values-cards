              ...
              {array1.map((string, index) => (
                <li key={index} className="card">
                  ...
                  <div>
                    <button
                      className="btn btn-2"
                      onClick={() => moveString(string, array2, setArray2)}
                    >
                      Array 2
                    </button>
                    <button
                      className="btn btn-3"
                      onClick={() => moveString(string, array3, setArray3)}
                    >
                      Array 3
                    </button>
                    <button
                      className="btn btn-4"
                      onClick={() => moveString(string, array4, setArray4)}
                    >
                      Array 4
                    </button>
                  </div>
            ...
            <ul>
              {array2.map((string, index) => (
                <li key={index} className="card">
                  ...
                  <button
                    className="btn btn-3"
                    onClick={() => moveString2(string, array3, setArray3)}
                  >
                    Move to Array 3
                  </button>
                  <button
                    className="btn btn-4"
                    onClick={() => moveString2(string, array4, setArray4)}
                  >
                    Move to Array 4
                  </button>
                </li>
            ...
            <ul>
              {array3.map((string, index) => (
                <li key={index} className="card">
                  ...
                  <button
                    className="btn btn-2"
                    onClick={() => moveString3(string, array2, setArray2)}
                  >
                    Move to Array 2
                  </button>
                  <button
                    className="btn btn-4"
                    onClick={() => moveString3(string, array4, setArray4)}
                  >
                    Move to Array 4
                  </button>
                </li>
            ...
            <ul>
              {array4.map((string, index) => (
                <li key={index} className="card">
                  ...
                  <button
                    className="btn btn-2"
                    onClick={() => moveString4(string, array2, setArray2)}
                  >
                    Move to Array 2
                  </button>
                  <button
                    className="btn btn-3"
                    onClick={() => moveString4(string, array3, setArray3)}
                  >
                    Move to Array 3
                  </button>
                </li>
